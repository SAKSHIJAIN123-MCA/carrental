...
if($lastInsertId)
{
$msg="Query Sent. We value your feedback! Please share your thoughts with us.";
}
else 
{
...
<title>Car Rental|| Feedback</title>
<!--Bootstrap -->
...
<section class="contact_us section-padding">
  <div class="container">
    <div  class="row">
      <div class="col-md-6">
        <h3>We value your feedback! Please share your thoughts with us.</h3>
        ...
        <div class="contact_form gray-bg">
          <form  method="post">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control white_bg" name="comment" rows="4" required></textarea>
            </div>
            <div class="form-group">
